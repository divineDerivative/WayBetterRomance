...
namespace BetterRomance
{
    ...
    internal class BetterRomanceMod : Mod
    {
        ...
        public BetterRomanceMod(ModContentPack content) : base(content)
        {
            ...
            ModManagement.RegisterMod("WBR.WayBetterRomance", typeof(BetterRomanceMod).Assembly.GetName().Name, new("0.4.0.1"), "<color=#1116e4>[WayBetterRomance]</color>", () => Settings.debugLogging);
        }
