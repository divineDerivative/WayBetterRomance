...
namespace BetterRomance.HarmonyPatches
{
    ...
    public static class Pawn_RelationsTracker_SecondaryLovinChanceFactor
    {
        ...
        public static bool Prefix(Pawn otherPawn, ref float __result, ref Pawn_RelationsTracker __instance, Pawn ___pawn)
        {
            ...
            __result = __instance.LovinAgeFactor(otherPawn) * __instance.PrettinessFactor(otherPawn) * targetBaseCapabilities * crossSpecies * RomanceUtilities.OrientationFactor(___pawn, otherPawn);
            return false;
        }
    }
